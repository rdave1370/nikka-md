 ...
 */
const sendSlides = async ({
    jid = "", // Default to an empty string if not provided
    botname = "My Bot", // Default bot name
    title = "Default Title", // Default title
    message = "Here are the slides!", // Default message
    links = [], // Default empty array if no links are provided
    messageInstance = {}, // Default empty object for messageInstance
    proto = {}, // Default empty object for proto
    prepareWAMessageMedia = () => {}, // Default empty function for prepareWAMessageMedia
    generateWAMessageFromContent = () => {}, // Default empty function for generateWAMessageFromContent
    context = {}, // Default empty object for context
}) => {
...
// Export the function with a simplified name
module.exports = sendSlides;
